...
<head>
  ...
  <title>Meus Produtos no Mercado Livre</title>
...
<body>
  ...
  <div class="container">
    ...
    <div class="product-card">
      ...
      <p>Descrição curta do produto.</p>
      <a href="https://mercadolivre.com/sec/2ghMmZq" target="_blank">Ver no Mercado Livre</a>
    </div>

    <!-- Adicione mais blocos de produtos conforme necessário -->
  </div>

  <footer>© 2025 - Minha Loja no Mercado Livre</footer>
</body>
</html>
